...
- Seguramente habrá que comprobar que el fichero existe antes de hacer nada con straight.el. En caso de no existir crearlo.
- De momento he indicado la ruta del directorio manualmente. Habrá que cambiarlo más adelante.
