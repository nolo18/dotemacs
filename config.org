...
#+todo: TODO INVESTIGANDO ENCURSO | HECHO
...
#+begin_src emacs-lisp
  (use-package modus-themes
    ...
    (setq
     ...
     modus-themes-prompts '(intense bold)		 ;Apariencia del minibuffer
     modus-themes-mode-line '(accented)		 ;Apariencia del modeline
     ...
     modus-themes-headings '((t . rainbow))	 ;Coloreado de los encabezados
...
** HECHO DONE Configurar modus-themes

[[modus-themes]]

Hay un sinfín de opciones que configurar en estos temas... Habrá que echarles a todas un buen vistazo y ver cuáles quiero cambiar.
